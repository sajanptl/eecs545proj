...
\section{Method}
Describe the graphical model of the document and present the algorithm described in the paper. This should be
like a summary of the algorithm's ideas. We can save the details of variational inference and gibbs sampling 
for our implementation section since we only have 8 pages worth of space.

\subsection{Graphical Model of a Document}
A picture here of the graphical model would also be good.
