...
\begin{enumerate}
\item $p(t_j | d_i)  = \frac{number of words assigned to t_j in d_i}{total number of words in d_i}$
\item $p( w_k |  t_j) = \frac{number of words assigned to t_j in d_i}{number of words assigned to t_j for all docs}$
\end{enumerate}
\end{enumerate}
