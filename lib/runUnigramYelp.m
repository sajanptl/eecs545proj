...
%% Load data
load ../data/yelp/LDA_input/W.mat
load ../data/yelp/LDA_input/W_test.mat
load ../data/yelp/LDA_input/WO.mat
...
%% save results
save yelp_unigram_test.mat lambda Ptrain Ptest PPlexTrain PPlexTest WplexTrain WplexTest
